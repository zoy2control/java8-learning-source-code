...
public abstract class AbstractScope<D extends GenericDeclaration>
    ...
    private final D recvr; // the declaration whose scope this instance represents·接受者recvr
    ...
    // ·待子类实现。计算 当前scope的 enclosingScope</p>
    // ·如果 当前scope是 最高层scope，那么必须返回

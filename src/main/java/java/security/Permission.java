...
public abstract class Permission implements Guard, java.io.Serializable {
    ...
    private String name;// ·Permission对象的名字
    ...
    /**
     * <p>
     *     ·封装SecurityManager.checkPermission（CF）。如果 permissionCheck不通过，抛异常
     * </p>
    ...
    /**
     * <p>
     *     ·校验是否 特定的permission被蕴含在 this obj's actions
     * </p>
    ...
    /**
     * <p>
     *     ·返回 actions字符串。子类可以延迟创建 stringRepresentation
     * </p>
     * Returns the actions as a String. This is abstract
     * so subclasses can defer creating a String representation until
     * one is needed. Subclasses should always return actions in what they
     * consider to be their canonical form（canonical form标准形式）.
     *
     * ·Eg：
     * For example, two FilePermission objects created via
     * the following:
     *
     * <pre>
     ...
     * </pre>
     *
     * ·只要调用 .getActions(),上面的两个例子都返回 "read,write"
     * both return

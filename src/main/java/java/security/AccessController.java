...
public final class AccessController {
    ...
    /**
     * <p>
     *     ·私有构造函数，不给任何人构造 AccessController
     * </p>
     ...
     * <p>
     *     ·本地方法：action获取 特权</p>
     *     ·若 action's run method抛 unchecked异常，会传播出去</p>
     *     ·注意，当 action运行的时候，任何 DomainCombiner与 当前AccessControlContext将会被忽略
     * </p>
     ...
     *                  {@code run} method.
     *
     * @param action the action to be performed.// ·将会被运行的 action
     *
    ...
    public static <T> T doPrivilegedWithCombiner(PrivilegedAction<T> action) {
        // ·返回 当前栈的 AccessControl上下文或者 若是为 null说明栈上有 特权系统代码
    ...
    public static <T> T doPrivileged(PrivilegedAction<T> action,
        AccessControlContext context, Permission... perms) {// ·可变入参Permission
    ...
    /**
     * ·创建包含了 limited privilege scope数据的 wrapper
     * <p>
    ...
    /**
     * <p>
     *     ·native方法。返回 当前栈的 AccessControl上下文或者 若是为 null说明栈上有 特权系统代码</p>
     *     ·获取栈中 所有callers的 protection domains，从 第一个class为 非空的protectionDomain </p>
     * </p>
    ...
    /**
     * <p>
     *     ·返回 继承AccessControlContext，这个 上下文在 线程创建的时候就存在了，</p>
     *     ·包私有，所以AccessControlContext可以使用它
     * </p>
    ...
    public static AccessControlContext getContext()
    {
        ...
        if (acc == null) {
            ...
            // ·对 AccessControlContext进行优化
            // ·C·AccessControlContext.CF·optimize()
            return acc.optimize();
        }
    }
        ...
        throws AccessControlException
    {
        ...
        // ·若 AccessControl上下文为null，说明有 特权系统代码在 栈上
        // if context is null, we had privileged system code on the stack.
        if (stack == null) {
            // ·上下文为null，只能用 C·AccessControlContext调用 就静态方法
            ...
            // ·要跳出 debug，而且 debug在 stack阶段
            if (dumpDebug && Debug.isOn("stack")) {
                Thread.dumpStack();// ·dumpStack
            }

            // ·要跳出 debug，而且 debug在 domain阶段
        ...
        // ·初始化：由 stack中获取 AccessControlContext
        AccessControlContext acc = stack.optimize();
        // ·AccessControlContext校验 Permission
